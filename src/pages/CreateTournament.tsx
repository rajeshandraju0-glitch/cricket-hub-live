    ...
    <div className="min-h-screen bg-background">
      ...
      <header className="bg-card border-b border-border p-4">
        <div className="container mx-auto flex items-center gap-4">
          ...
          <div>
            <h1 className="font-display text-xl">CREATE TOURNAMENT</h1>
            <p className="text-sm text-muted-foreground">Set up a new cricket tournament</p>
          </div>
        </div>
      </header>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="bg-card border border-border rounded-2xl p-6">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="font-display text-xl">TOURNAMENT DETAILS</h2>
              </div>
            ...
            <div className="bg-card border border-border rounded-2xl p-6">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="font-display text-xl">SCHEDULE & FORMAT</h2>
              </div>
